   ...
   ext.stop_sending_commands_to_target = function () {
    ...
    var descriptor = {
        blocks: [
            ...
            ['w', translate.Body_turn, 'Body_turn', translate.body_turn_direction[0], translate.body_turn_degree[6]],
          ...
          //  ['', translate.Cancel_actionset, 'Cancel_actionset'],
            ...
            ['h', translate.when_listen_and_run, 'when_listen_and_run', translate.sentence_type[0]],

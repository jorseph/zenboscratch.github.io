(function (ext) {
   ...
   ext.stop_sending_commands_to_target = function () {
	...
	tw: {
	    ...
	    when_listen_and_run: '當 Zenbo  聽到 %m.sentence_type',
    ...
    var descriptor = {
        blocks: [
            ...
            ['w', translate.Body_movement, 'Body_movement', "192.168.0.1", translate.move_direction[0], translate.move_far[0], translate.move_speed[0]],
            ['', translate.Stop_moving, 'Stop_moving', "192.168.0.1"],
            ['w', translate.Head_movement, 'Head_movement', "192.168.0.1", translate.head_direction[0], translate.head_degree[3]], 
            ['w', translate.Body_turn, 'Body_turn', "192.168.0.1", translate.body_turn_direction[0], translate.body_turn_degree[6]],
          ...
          //  ['', translate.Cancel_actionset, 'Cancel_actionset', "192.168.0.1"],
            ...
            ['w', translate.TTS, 'TTS', "192.168.0.1", translate.tts_type[0]],
            ['w', translate.TTS_editor, 'TTS_editor', "192.168.0.1", translate.ttsEditorDefaultText],
            ['', translate.Adjust_stream_volume, 'Adjust_stream_volume', "192.168.0.1", translate.volume_option_type[3], translate.volume_type[0]],
            ['w', translate.Adjust_tts_and_speed, 'Adjust_tts_and_speed', "192.168.0.1", translate.ttsEditorDefaultText, translate.tts_speed_type[1]],

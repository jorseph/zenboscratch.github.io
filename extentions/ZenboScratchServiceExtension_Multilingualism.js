...
ext.Add_and_update_sentence_number = function (ip) {
    ...
    var TRANSLATIONS = {
	    ...
	    head_direction: ["left", "right", "top", "bottom"],
            ...
            facial_type: ["interested", "doubting", "proud", "defualt", "happy", "expecting", "shocked", "questioning", "impatient", "confident", "active", "pleased", "helpless", "serious", "worried", "pretending", "lazy", "aware_R", "tired", "shy", "innocent", "singing", "aware_L", "default_still"],
            ...
            playVideosInYoutubeItems: ["start", "finish"],
            displayUrlPicturesItems: ["start", "finish"],
            playUrlMusicItems: ["start", "finish"],
            openDriveVideoUrlItems: ["start", "finish"],

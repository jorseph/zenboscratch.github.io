...
ext.Add_and_update_sentence_number = function (ip) {
	...
	var TRANSLATIONS = {
        us: {
            ...
            Remote_control_body: 'IP %s move body %m.remote_control_body_type',
            ...
            displayUrlPicturesItems: ["open", "close"],
            playUrlMusicItems: ["open", "close"],
            openDriveVideoUrlItems: ["open", "close"],
            openDriveAudioUrlItems: ["open", "close"],
            openDrivePictureUrlItems: ["open", "close"],
            openDriveDocumentUrlItems: ["open", "close"],

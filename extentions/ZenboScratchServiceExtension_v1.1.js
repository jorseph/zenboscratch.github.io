(function (ext) {
    ...
    ext.Speak_and_listen = function (ip){
        ...
        $.ajax({
			...
			if (setupFlag == true) {
				flagArray.data.push( { device: ip,  sentence_1_flag: false, sentence_2_flag: false, sentence_3_flag: false, sentence_4_flag: false, sentence_5_flag: false} );
    ...
    ext.Get_sentences1 = function (ip, callback){
        console.log("Get_sentences1");
        console.log(ip);
        $.ajax({
            type: 'GET',
            url: 'http://' + ip + port + '/?name=Get_sentences1',
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Get_sentences2 = function (ip, callback){
        console.log("Get_sentences2");
        console.log(ip);
        $.ajax({
            type: 'GET',
            url: 'http://' + ip + port + '/?name=Get_sentences2',
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Get_sentences3 = function (ip, callback){
        console.log("Get_sentences3");
        console.log(ip);
        $.ajax({
            type: 'GET',
            url: 'http://' + ip + port + '/?name=Get_sentences3',
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Get_sentences4 = function (ip, callback){
        console.log("Get_sentences4");
        console.log(ip);
        $.ajax({
            type: 'GET',
            url: 'http://' + ip + port + '/?name=Get_sentences4',
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");
    ...
    ext.Get_sentences5 = function (ip, callback){
        console.log("Get_sentences5");
        console.log(ip);
        $.ajax({
            type: 'GET',
            url: 'http://' + ip + port + '/?name=Get_sentences5',
            dataType: 'text',
            crossDomain: true,
            success: function (data) {
                console.log("success handler");

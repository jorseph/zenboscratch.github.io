...
ext.Add_and_update_sentence_number = function (ip) {
    ...
    var descriptor = {
        blocks: [
            ...
            ['', 'IP %s %m.displayUrlPicturesItems 瀏覽線上圖片: %s', 'displayUrlPictures', "192.168.0.1", '開始', 'https://raw.githubusercontent.com/zenboscratch/zenboscratch.github.io/master/images/banner.png'],
            ...
            ['', 'IP %s %m.openDriveDocumentUrlItems 瀏覽 Google Drive 文件: %s', 'openDriveDocumentUrl', "192.168.0.1", '開始', 'https://drive.google.com/open?id=0B5o6VwYT7Naib2NFbEZSMVRhQms'],
        ],
        menus: {
